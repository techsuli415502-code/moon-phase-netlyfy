        ...
        <div className="mt-12 grid gap-8 lg:grid-cols-3">
          <article className="glass-card rounded-2xl p-6 sm:p-8">
            <div className="flex items-center gap-3">
              <div
                className="grid h-10 w-10 place-items-center rounded-full bg-[oklch(0.55_0.18_285/20%)] text-lg font-bold text-[oklch(0.92_0.06_75)]"
                aria-hidden="true"
              >
                1
              </div>
        ...
        <div className="mt-10">
          <div className="glass-card rounded-2xl p-6 sm:p-10">
            <div className="grid gap-8 md:grid-cols-2 md:items-center">
              ...
              <div className="relative flex aspect-square items-center justify-center rounded-xl border border-white/10 bg-gradient-to-br from-[oklch(0.12_0.03_275/80%)] to-[oklch(0.07_0.02_270/90%)] p-8">
                <div
